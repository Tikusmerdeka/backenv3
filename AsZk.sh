...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Tikusmerdeka/backenv3/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Tikusmerdeka/backenv3/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Tikusmerdeka/backenv3/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Tikusmerdeka/backenv3/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Tikusmerdeka/backenv3/main/ip | grep $ipsaya | awk '{print $3}')
...
wget "http://raw.githubusercontent.com/Tikusmerdeka/backenv3/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
